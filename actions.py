...
def dropFirstValve():
    ...
    g.turn_with_gyro(70, -70, 90)
    g.drive_distance(-70, 3.9)
    g.turn_with_gyro(30, -30, 25)
    u.move_servo(c.servoArm, c.armValveDrop)
    u.move_servo(c.servoWrist, c.wristVertical)
    g.turn_with_gyro(-15, 15, 20)
    g.drive_distance(30, .5)
    g.turn_with_gyro(-15, 15, 10)
    u.move_servo(c.servoClaw, c.clawOpen)
    u.move_servo(c.servoArm, c.armDropOff - 100)
